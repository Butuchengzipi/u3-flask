...
class FlaskClientTestCase(unittest.TestCase):
    def setUp(self):
        ...
        db.create_all()
        Role.insert_roles()
        self.client = self.app.test_client(use_cookies=True)  # 新增 self.client 实例变量，use_cookies，使用cookie
    ...
    def test_home_page(self):   #
        ...
        self.assertTrue('Stranger' in response.get_data(as_text=True))  # response.get_data获取响应主体，as_text使得返回一个字符串
